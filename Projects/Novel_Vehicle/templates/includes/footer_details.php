    ...
    <div class="container" id="foot">
     <div class="row">
       <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
         <div class="row">
           <div class="col-sm-3 col-md-3 col-lg-3 col-xs-3">
             <ul> 
              <li><h3><strong>NovelVehicle</strong></h3></li>
           ...
           <div class="col-sm-3 col-md-3 col-lg-3 col-xs-3">
             <ul>
              ...
              <li><a href="<?php echo $path ?>templates/views/seller_login_registration.php">Seller Login</a></li>
              <li><a href="<?php echo $path ?>templates/views/seller_login_registration.php">Register Shop</a></li>
      ...
      <div class="text-center text-warning copyright" id="foot">
     	<p>&copy All right reserves with NovelVehicle</p>
     </div>
</section>